...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.intuneget.com/blog/deploy-winget-apps-to-intune",
  },
  openGraph: {
    title: post.title,
    description: post.description,
    url: "https://www.intuneget.com/blog/deploy-winget-apps-to-intune",
    type: "article",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: post.title,
      item: "https://www.intuneget.com/blog/deploy-winget-apps-to-intune",
    },
  ],
};
...
const articleJsonLd = {
  ...
  mainEntityOfPage:
    "https://www.intuneget.com/blog/deploy-winget-apps-to-intune",
  keywords: [
    "Intune Winget",

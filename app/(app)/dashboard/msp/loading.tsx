      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="glass-light rounded-xl p-6 border border-overlay/5">
            <div className="h-5 w-40 bg-overlay/5 rounded animate-pulse mb-6" />
            <div className="space-y-3">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex items-center gap-4 py-3 border-b border-overlay/5 last:border-0">
                  ...
                  <div className="h-4 w-1/4 bg-overlay/5 rounded animate-pulse" />
                  <div className="h-4 w-1/6 bg-overlay/5 rounded animate-pulse" />
                  <div className="h-6 w-20 bg-overlay/5 rounded-full animate-pulse" />
                </div>
              ))}
            </div>
          </div>

  ...
  return (
    <div className="space-y-12">
              ...
              <div className="flex-1">
                {item.url ? (
                  <a
                    ...
                    className="font-medium text-white hover:text-accent-cyan transition-colors inline-flex items-center gap-1"
                  >
                    {item.name}
                ...
                <span className="text-sm text-zinc-500 ml-2">{item.note}</span>
              </div>
            </div>
          ))}
        </div>
          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  <code className="text-xs text-zinc-500">sqlite</code>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
              ...
              <TableRow>
                ...
                <TableCell className="text-sm">.env.local, Docker</TableCell>
                <TableCell>
                  <code className="text-xs text-zinc-500">local</code>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell>
                  <code className="text-xs text-zinc-500">random-32-char...</code>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell>
                  <code className="text-xs text-zinc-500">12345678-1234-...</code>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell>
                  <code className="text-xs text-zinc-500">Abc123~...</code>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
      ...
      <section>
        ...
        <Steps>
          <StepIndicator step={1} title="Set Up Azure AD App Registration">
            <p>
              Create a multi-tenant app registration in Microsoft Entra ID to enable
              authentication and Intune access.
            </p>
            <ol className="list-decimal list-inside mt-4 space-y-2 text-zinc-300">
              <li>
                Go to{" "}
                <a
...
set AZURE_CLIENT_SECRET=<from-azure>`}
      ...
      <section>
        ...
        <p className="text-zinc-400 mb-4">
          After deployment, update your Azure AD app registration with your
          production URL:
        </p>
      ...
      <section>
        ...
        <div className="mt-6 space-y-6">
          ...
          <div>
            <h3 className="text-lg font-medium text-white mb-3">Running as a Service</h3>

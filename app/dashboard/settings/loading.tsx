    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="glass-dark rounded-xl p-6 border border-white/5">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between py-3">
            ...
            <div className="h-4 w-64 bg-white/5 rounded animate-pulse font-mono" />
          </div>
        </div>
      </div>
      ...
      <div className="glass-dark rounded-xl p-6 border border-white/5">
        ...
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="p-3 bg-bg-elevated rounded-lg border border-white/5 flex items-start gap-3">
              <div className="w-5 h-5 rounded-full bg-white/5 animate-pulse mt-0.5" />

...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We're currently in the final development phase and expect to release IntuneGet soon. Join our waitlist to be among the first to know when it's ready and get early access to the tool.",
  },
];

...
const candidateId = '1607ce7d-3498-448b-b9dd-d98a84b23191';
const profileHash = '54D452FFB1DF28C8B24B6FC7003EADA14384FE1413BAF4DE7E9B65022E988A84';
const tuple = { winget_id: 'StablyAI.Orca', version: '1.4.203', architecture: 'x64',
  installer_sha256: 'DC347211CE31DC1D37BD6522B2BB96169747F626A19754C57F6868769E878A7C' };
...
if (candidates.length !== 1 || results.length !== 1 || c.github_run_id !== '34966123863' || (r.github_run_id != null && String(r.github_run_id) !== c.github_run_id) ||

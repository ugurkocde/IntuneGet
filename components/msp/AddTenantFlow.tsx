    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        <div className={cn(
          ...
          step === 'details' ? 'text-accent-cyan' : 'text-zinc-500'
        )}>
          <span className={cn(
            'w-6 h-6 rounded-full flex items-center justify-center text-xs font-medium',
            step === 'details' ? 'bg-accent-cyan text-black' : 'bg-white/10 text-zinc-400'
          )}>1</span>
          <span>Details</span>
        </div>
        ...
        <div className={cn(
          'flex items-center gap-2 text-sm',
          step === 'consent' ? 'text-accent-cyan' : 'text-zinc-500'
        )}>
          <span className={cn(
            'w-6 h-6 rounded-full flex items-center justify-center text-xs font-medium',
            step === 'consent' ? 'bg-accent-cyan text-black' : 'bg-white/10 text-zinc-400'
          )}>2</span>
          <span>Consent</span>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="p-6 rounded-xl bg-white/5 border border-white/10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="font-medium text-white">Add Customer Tenant</h3>
                <p className="text-sm text-zinc-500">Enter details about your customer's organization</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 bg-black/30 border border-white/10 rounded-lg text-white placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-accent-cyan/50 focus:border-accent-cyan/50 resize-none"
                  maxLength={500}
                />
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div className="p-6 rounded-xl bg-white/5 border border-white/10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="font-medium text-white">Tenant Created</h3>
                <p className="text-sm text-zinc-500">Now share the consent link with your customer</p>
              </div>
            </div>
